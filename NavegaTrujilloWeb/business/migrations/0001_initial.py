    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ubication', models.CharField(max_length=150, validators=[django.core.validators.MinLengthValidator(0)])),
            ],
        ),
        migrations.CreateModel(
            name='Ship',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('rental_start_date', models.DateField(validators=[django.core.validators.MinValueValidator(datetime.date(2024, 11, 13))])),
                ('rental_end_date', models.DateField(validators=[django.core.validators.MinValueValidator(datetime.date(2024, 11, 13))])),
                ...
                ('port', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='business.port')),
